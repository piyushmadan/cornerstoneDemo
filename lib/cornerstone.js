...
(function (cornerstone) {
    ...
    Transform.prototype.transformPointInverse = function(x, y) {
        ...
        // x = ( (px/this.m[2]) - (this.m[4]/this.m[2]) - (py/this.m[3]) - (this.m[5]/this.m[3]) ) / (  (this.m[0]/this.m[2]) - (this.m[1]/this.m[3]) );
        // y = ( px - x*this.m[0] - this.m[4] ) / this.m[2] ;
        if(this.m[0]==0){ y = px/this.m[2] }
        if(this.m[1]==0){ y = py/this.m[3] }
        if(this.m[2]==0){ x = px/this.m[0] }
        if(this.m[3]==0){ x = py/this.m[1] }
        if(this.m[0]!=0 && this.m[1]!=0 && this.m[2]!=0 && this.m[3]!=0 ){ 
            y = ((px/this.m[0]) - (py/this.m[1])) / ((this.m[2]/this.m[0]) - (this.m[3]/this.m[1])) ;
            x = (px/this.m[0]) - (y*this.m[2]);
        }
